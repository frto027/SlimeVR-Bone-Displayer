...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean ToggleAlterBone
        {
            get
            {
                return SteamVR_Actions.default_ToggleAlterBone;
            }
        }
        
        public virtual SteamVR_Action_Boolean ResetAlterBone
        {
            get
            {
                return SteamVR_Actions.default_ResetAlterBone;
            }
        }
        
        public virtual SteamVR_Action_Vector2 MoveOrRotAlterBone
        {
            get
            {
                return SteamVR_Actions.default_MoveOrRotAlterBone;
            }
        }
        
        public virtual SteamVR_Action_Boolean ToggleMirror
        {
            get
            {
                return SteamVR_Actions.default_ToggleMirror;
            }
        }
        
        public virtual SteamVR_Action_Boolean ruler_ctrl
        {
            get
            {
                return SteamVR_Actions.default_ruler_ctrl;
            }
        }
        
        public virtual SteamVR_Action_Boolean reset_ui
        {
            get
            {
                return SteamVR_Actions.default_reset_ui;
            }
        }
